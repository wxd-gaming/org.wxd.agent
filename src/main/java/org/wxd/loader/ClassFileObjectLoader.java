...
public class ClassFileObjectLoader extends ClassLoader {
    ...
    private Map<String, JavaFileObject4ClassStream> classFileObjectMap = new ConcurrentHashMap<>();
    ...
    public Map<String, JavaFileObject4ClassStream> getClassFileObjectMap() {
        return classFileObjectMap;
    }
